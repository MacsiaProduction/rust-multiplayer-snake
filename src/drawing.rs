...
pub fn to_gui_coord_f64(game_coord: u64) -> f64 {
    (game_coord as f64) * BLOCK_SIZE
}

pub fn to_gui_coord_u64(game_coord: u64) -> u64 {
    to_gui_coord_f64(game_coord) as u64
}

pub fn draw_block(color: Color, x: u64, y: u64, con: &Context, g: &mut G2d) {
...
pub fn draw_rectangle(color: Color, start_x: u64, start_y: u64, width: u64, height: u64, con: &Context, g: &mut G2d) {
